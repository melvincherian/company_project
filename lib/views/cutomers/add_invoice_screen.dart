...
class _AddInvoiceScreenState extends State<AddInvoiceScreen> {
  bool _isListening = false;
  TextEditingController? _activeController; // Track which field is currently active
  ...
  void _startListening(TextEditingController controller) async {
    // Store which controller is currently active
        ...
        _speech.listen(
          onResult: (result) {
            if (_activeController != null && mounted) {
              setState(() {
                // Update the text of the active controller
  ...
  Widget _buildTextField(TextEditingController controller, String label,
      {TextInputType inputType = TextInputType.text}) {
    // Check if this controller is the active one for mic
    bool isActive = _activeController == controller && _isListening;
        ...
        suffixIcon: GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: isActive ? Colors.red : const Color.fromARGB(255, 97, 74, 160),
