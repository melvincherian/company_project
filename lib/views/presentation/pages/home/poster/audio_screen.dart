// import 'package:company_project/views/presentation/pages/home/poster/customize_audio_screen.dart';
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return ListTile(
            ...
            subtitle: Text('00:${30 + index} seconds'),
            trailing: IconButton(
              icon: const Icon(Icons.play_arrow),
              onPressed: () {
                // Play audio logic
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(content: Text('Playing Audio Track ${index + 1}')),
                );
              },
            ),
            onTap: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text('Audio Track ${index + 1} added')),
              );
            },
          );
        },
