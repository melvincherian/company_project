...
// //     if (_images.length > 1) {
// //       _imageTimer =
// //           Timer.periodic(Duration(milliseconds: _durationPerImageMs), (timer) {
// //         if (mounted) {
// //           setState(() {
...
// // import 'dart:io';
// // import 'dart:async';
// // import 'package:company_project/views/presentation/pages/home/video/edit_screen.dart';
// // import 'package:flutter/material.dart';
// // import 'package:image_picker/image_picker.dart';

// // // Import the edit screen we just created
...
//             // For transition effect, reset when image changes
//             if (_selectedAnimation == AnimationType.transition) {
//               _animationValue = 1.0; // Keep at full animation for transition
//             } else {
//               _animationValue = 0.0; // Reset for continuous animation
//             }
//           }
//         });
//       }
...
//       ffmpegCommand = '-i ${videoFile.path} -vf colorchannelmixer=.3:.4:.3:0:.3:.4:.3:0:.3:.4:.3 $outputPath';
//       break;
      
//     case FilterType.watercolor:
//       // Apply watercolor-like effect
//       ffmpegCommand = '-i ${videoFile.path} -vf "colorbalance=rs=0.1:gs=0:bs=0.2,boxblur=1:1" $outputPath';
//       break;
      
//     case FilterType.snow:
//       // Add snow effect and cool tint
//       ffmpegCommand = '-i ${videoFile.path} -vf "colorbalance=rm=-0.1:bm=0.1,geq=\'r=r(X,Y):g=g(X,Y):b=b(X,Y)+if(mod(X+Y,30)<1.5*random(1),255-b(X,Y),0)\'" $outputPath';
//       break;
      
//     case FilterType.waterDrops:
//       // A simplified water drops effect
//       ffmpegCommand = '-i ${videoFile.path} -vf "colorbalance=bm=0.2,unsharp=3:3:1" $outputPath';
//       break;
...
//         final double offset = 200.0 * (1.0 - _animationValue);
...
//         final double scale = 0.5 + (0.5 * _animationValue);
...
//           // Cross-fade between current and previous image
...
//         }
//       },
//       // Using behavior: HitTestBehavior.translucent allows taps to be detected 
//       // even when there's nothing visible at the tap location
...
//                                   )
//                                 : _buildAnimatedImage(_processedImages.isNotEmpty && _currentIndex < _processedImages.length
...
//                                               value: _currentIndex.toDouble(),
//                                               min: 0,
//                                               max: (_images.length - 1).toDouble().clamp(0, double.infinity),
//                                               onChanged: (value) {
//                                                 setState(() {
//                                                   _currentIndex = value.toInt();
//                                                   // Update time based on slider position
...
//                               _buildFilterOption(FilterType.blackWhite, 'Black&White'),
//                               _buildFilterOption(FilterType.watercolor, 'Watercolor'),
//                               _buildFilterOption(FilterType.snow, 'Snow'),
//                               _buildFilterOption(FilterType.waterDrops, 'WaterDrops'),
//                             ],
//                           ),
//                         ),
//                       ],
...
//                               _buildAnimationOption(AnimationType.leftRight, 'LeftRight'),
//                               _buildAnimationOption(AnimationType.upDown, 'UpDown'),
//                               _buildAnimationOption(AnimationType.window, 'Window'),
//                               _buildAnimationOption(AnimationType.gradient, 'Gradient'),
//                               _buildAnimationOption(AnimationType.transition, 'Transition'),
//                             ],
//                           ),
//                         ),
//                       ],
...
//   static Future<void> saveVideoToGallery(List<File> images, int durationPerImageMs) async {
...
//   static Future<img.Image> applyAdvancedFilter(img.Image image, FilterType filterType) async {
//     switch (filterType) {
//       case FilterType.none:
//         return image;
