...
//                           backgroundColor: Colors.red,
//                         ),
//                         child: const Text('Delete Element',style: TextStyle(color: Colors.white),),
//                       ),
//                       ElevatedButton(
//                         onPressed: () {
//                           setState(() {
...
//                       backgroundColor: Colors.red,
//                     ),
//                     child: const Text('Delete Text',style: TextStyle(color: Colors.white),),
//                   ),
//                   ElevatedButton(
//                     onPressed: () {
//                       if (_textController.text.isNotEmpty) {
...
//               GestureDetector(
//               onTap: () {
//                 // Directly pick background image if it's not already selected
//                 if (_backgroundImage == null) {
//                   _pickBackgroundImage();
//                 }
//               },
