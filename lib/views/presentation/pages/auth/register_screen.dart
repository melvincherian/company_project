...
//                                     return;
//                                   }
//                                   final isSuccess = await _controller.loginUser(context, mobile);
//                                   if (isSuccess) {
//                                     Navigator.push(
//                                       context,
...
//         child: LayoutBuilder(
//           builder: (context, constraints) {
//             // Calculate yellow circle height to ensure text is below it
//             final yellowCircleHeight = constraints.maxHeight * 0.5;
            
//             return Stack(
//               children: [
//                 // Yellow Circle Background - Fixed at the top
//                 Positioned(
//                   top: -constraints.maxHeight * 0.4,
//                   left: -screenWidth * 0.5,
//                   child: Container(
